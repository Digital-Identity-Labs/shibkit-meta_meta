...
module Shibkit
  ...
  class Config
    ...
    CONFIG_DEFAULTS = {
      ...
      :sim_sp_session_lifetime        => 28800,
      :sim_sp_session_idle            => 3600,
      ...
      :sim_idp_attr_filter            => false,
      :sim_sp_attr_mappings_file      => "/data/simulator_sp_attr_mapping.yml".to_absolute_path,
      :sim_sp_attr_mapper             => :default_saml2,
